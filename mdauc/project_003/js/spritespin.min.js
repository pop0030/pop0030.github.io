...
function() {
    ...
    e.extendApi({
        ...
        updateLane: function(t) {
            return e.updateFrame(this.data, this.data.frame, t), this
        },
        skipFrames: function(t) {
            var n = this.data;
            return e.updateFrame(n, n.frame + (n.reverse ? -t : +t)), this
        },
        skipLanes: function(t) {
            var n = this.data;
            return e.updateFrame(n, n.frame, n.lane + (n.reverse ? -t : +t)), this
        },
        nextFrame: function() {
