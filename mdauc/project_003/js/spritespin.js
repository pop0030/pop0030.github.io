...
(function($) {
    ...
    SpriteSpin.extendApi({
        ...
        // Updates SpriteSpin to the specified frame.
        updateLane: function(lane) {
            SpriteSpin.updateFrame(this.data, this.data.frame, lane);
            return this;
        },
        ...
        skipLanes: function(step) {
            var data = this.data;
            SpriteSpin.updateFrame(data, data.frame, data.lane + (data.reverse ? -step : +step));
            return this;
        },
    ...
    SpriteSpin.extendApi({
        ...
        requestFullscreen: function(opts) {
            ...
            bindChangeEvent(function() {
                if (isFullscreen()) {
                    // ENTER
                    data.width = window.screen.height;
...
(function($, SpriteSpin) {
    ...
    function updateInputZoom(e, data) {
        e.preventDefault();
