            ...
            if (has_touch || screen.width <= 699) {
                ...
                el.mouseenter(function(e) {
                    ...
                    el.find("> .ibg-bg").css({
                        ...
                        "-webkit-transition": "-webkit-transform " + settings.animationSpeed + " ease",
                        "-moz-transition": "-moz-transform " + settings.animationSpeed + " ease",
                        "-o-transition": "-o-transform " + settings.animationSpeed + " ease",
                        "transition": "transform " + settings.animationSpeed + " ease"
